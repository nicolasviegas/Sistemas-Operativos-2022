...
static void deserializar_NO_OP(void* stream, uint8_t* nota1, uint8_t* nota2) {
...
// MIRAR_NETFLIX
static void* serializar_IO(size_t* size, char* peli, uint8_t cant_pochoclos) {
...
static void deserializar_IO(void* stream, char** peli, uint8_t* cant_pochoclos) {
    /*// Peli
    size_t size_peli;
